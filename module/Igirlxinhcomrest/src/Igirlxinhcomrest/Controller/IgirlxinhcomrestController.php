...
namespace Igirlxinhcomrest\Controller;
...
class IgirlxinhcomrestController extends AbstractRestfulController
{
    ...
    {
    	//echo 'get list';
    	$results = $this->getIgirlxinhcomTable()->fetch_All_Igirlxinhcomrest_Rest_Orderbyiddesc();
        $data = array();
